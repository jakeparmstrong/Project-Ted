...
Play ~the most recent~ an older version on [itch.io](https://jarms.itch.io/project-ted). To play the most recent version, download both files in Project-Ted/Exe to the same directory, and run ted_recent.exe  
